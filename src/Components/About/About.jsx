  ...
  return (
    <section className="about section">
      <div className="secContainer">
        ...
        <div className="mainContent container grid" data-aos="fade-up" data-aos-duration="3000">
        ...
        <div className="videoCard container" data-aos="zoom-in">
          <div className="cardContent grid">


            <div className="cardText" data-aos="fade-right">
              <h2>
                <span className='welcome'>Welcome to</span> A2K GROUP
              </h2>
              <p>
